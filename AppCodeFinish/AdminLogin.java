...
public class AdminLogin extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String str[] = string[0].split("\\s+");
        String str1[] = string[1].split("\\s+");
        //Toast.makeText(getApplicationContext(),"str:"+ string[1], Toast.LENGTH_SHORT).show();
       // Toast.makeText(getApplicationContext(),"str1:"+ str[1], Toast.LENGTH_SHORT).show();
        ...
        for(int ii =0;ii<str1.length;ii=ii+3){
            NAME = str1[ii];
            lat = Double.parseDouble(str1[ii+1]);
            lng = Double.parseDouble(str1[ii+2]);
            mMap.addMarker(new MarkerOptions().position( new LatLng(lat, lng)).title(NAME).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
        }
